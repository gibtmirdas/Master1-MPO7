...
/**
 * This statistic calculates the number of cache hit that have been calculated from the beginning.
 *
 * @author Jacques Fontignie
 * @version 6 avr. 2005
 *
 */
public class CacheHitStatistic<T extends GlobalIndividual> implements Statistic<Double,T>{
    ...
    public Double evaluate(Population<T> population) {
        ...
        return Double.valueOf(((CachingObject) population).getCacheHit());
    }
