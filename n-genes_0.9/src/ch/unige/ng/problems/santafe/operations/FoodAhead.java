...
/**
 * This class jumps to the next instruction if there is food and jump two instructions if there is no food.
 *
 * @author Jacques Fontignie
 * @version 13 janv. 2005
 */
public class FoodAhead implements Operation<Integer> {

    private Board board;

    @Forced
            public void setBoard(Board problem) {
        this.board = problem;
    }
    ...
    public void exec(DataStack<Integer> dataStack, ExecutionPointer pointer) {
        ...
        pointer.setRelativeJump((board.containsFood(x, y)) ? 1 : 3);
    }
