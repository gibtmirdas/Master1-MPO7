...
package ch.unige.ng.problems.santafe.evaluations;
 ...
 * @version 8 avr. 2005
 * @see ch.unige.ng.species.stackGP.evaluations.ControlEvaluator
 */
public class ControlEvaluator implements IEvaluator {
    ...
    public ControlEvaluator(int iterationMax) {
        this();
    ...
    public <S,T extends Operation<S>> int evaluate(DataStack<S> stack, Evaluable<T> evaluable) {
        ...
        while (numSteps++ < iterationMax) { //And we are not too much evaluating (The counter is incremented)
