...
/**
 * This interface defines a condition. To know if an event or a log has to be called, a condition is tested.
 * If a condition is fired, then the event or the log is fired.  
 *
