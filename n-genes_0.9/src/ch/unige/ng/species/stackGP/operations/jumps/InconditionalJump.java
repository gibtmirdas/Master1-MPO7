 ...
 * @version 3 janv. 2005
 */
public class InconditionalJump implements Operation<Double> {

    public void exec(DataStack<Double> dataStack,ExecutionPointer pointer) {
        double offset = dataStack.pop();
        pointer.setRelativeJump((int) offset);
    }
    ...
    public String toString() {
        return "Relative Inconditionnal jump";
    }
}
