 ...
 * @version 8 avr. 2005
 */
public class BeginWhile implements Control<Double> {
    public Type getType() {
    ...
    public void exec(DataStack<java.lang.Double> dataStack, ExecutionPointer pointer) {
    ...
    public boolean isCompatible(Control<Double> control) {
        return (control instanceof EndWhile);
    }
