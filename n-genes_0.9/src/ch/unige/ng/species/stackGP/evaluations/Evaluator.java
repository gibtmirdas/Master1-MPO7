...
/**
 * This class evaluates an individual that possess some Operation in the genotype
 *
...
public class Evaluator implements IEvaluator {
     ...
     * @param iterationMax
     */
    public Evaluator(int iterationMax){
        this();
    ...
    public <S,T extends Operation<S>> int evaluate(DataStack<S> stack, Evaluable<T> evaluable) {
        ...
        while ((pointer.getHead() < size && pointer.getHead() >= 0) && numSteps++ < iterationMax) {
